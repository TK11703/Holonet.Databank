...
public class AgentClient : ClientBase
{
	...
	public AgentClient(HttpClient httpClient, ILogger<AgentClient> logger, ITokenAcquisition tokenAcquisition, IOptions<AppSettings> options) : base(tokenAcquisition, options)
	{
