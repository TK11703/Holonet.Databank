...
(
	...
	CONSTRAINT [FK_Aliases_HistoricalEvents] FOREIGN KEY ([HistoricalEventId]) REFERENCES [HistoricalEvents]([Id]),
...
GO
CREATE INDEX [idx_Aliases_HistoricalEventId] ON [dbo].[Aliases]([HistoricalEventId]);
GO
